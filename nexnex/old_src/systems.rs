...
//     let ldtk_handle = asset_server.load("Typical_2D_platformer_example.ldtk").into();
...
pub fn setup(mut commands: Commands, asset_server: Res<AssetServer>, mut rapier_config: Query<&mut RapierConfiguration>) {
